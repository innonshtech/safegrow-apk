            ...
            <div className={styles.attendanceTab}>
              <div className={styles.attSidebar}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                  <div className={styles.monthSelector} style={{ margin: 0 }}>
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M15 18l-6-6 6-6"/></svg>
                    <span>This Month</span>
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M9 18l6-6-6-6"/></svg>
                  </div>
                  <a href={`/api/v1/admin/export?type=attendance&employeeId=${employee.id}`} className="btn" style={{ padding: '6px 12px', fontSize: '13px', background: '#f3f4f6', border: '1px solid #d1d5db', borderRadius: '6px', textDecoration: 'none', color: '#374151', display: 'flex', alignItems: 'center', gap: '6px' }}>
